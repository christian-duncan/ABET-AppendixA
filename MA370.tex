\label{MA370}  % Replace course code with ID - e.g. \label{CSC110}
\begin{enumerate}[1.]
...
\item prerequisites or co-requisites\\
  {\bfseries
    ...
    Prerequisites: any 300-level Math course (Minimum Grade C-)
    % Corequisites: 
  }
...
\item specific outcomes of instruction\\ % , for example, ``The student will be able to explain the significance of current research about a particular topic.'' \\
  {\bfseries
    % 
    % --------------------------
    Course Learning Objectives (the student will be):
    \begin{enumerate}[1.]
      \item Acquainted to the fundamentals of number theory
      \item Engaged in mathematical inquiry
    \end{enumerate}
  }
