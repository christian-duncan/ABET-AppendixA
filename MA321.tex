\label{MA321}  % Replace course code with ID - e.g. \label{CSC110}
\begin{enumerate}[1.]
...
\item prerequisites or co-requisites\\
  {\bfseries
    ...
    Prerequisites: MA229, MA301 (Minimum Grade C-) \\  % Just some defaults
    % Corequisites: 
  }
...
\item specific outcomes of instruction\\ % , for example, ``The student will be able to explain the significance of current research about a particular topic.'' \\
  {\bfseries
  Not specified explicitly.  % The class is VERY ABSTRACT
    % 
    % --------------------------
